...
- v 1.2.5: add support for generating YAML swagger API doc besides default JSON format.

- v 1.2.4.1: bug fix for v 1.2.4.

- v 1.2.4: add support for detecting and resolving CGLib proxied controllers
